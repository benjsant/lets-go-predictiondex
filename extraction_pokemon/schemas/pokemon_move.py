# extraction_pokemon/schemas/pokemon_move.py
...
from extraction_pokemon.schemas.learn_method import LearnMethodOut
from extraction_pokemon.schemas.move import MoveListItem
