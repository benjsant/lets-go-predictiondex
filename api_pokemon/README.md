...
L'endpoint `/predict/best-move` utilise un modèle XGBoost entraîné (88.23% accuracy - modèle v2 multi-scénarios) pour recommander la meilleure capacité à utiliser contre un adversaire dans Pokémon Let's Go.
